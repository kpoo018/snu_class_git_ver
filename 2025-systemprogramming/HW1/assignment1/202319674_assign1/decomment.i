...
# 145 "./src/decomment.c"
       "0"
# 145 "./src/decomment.c" 3 4
       , "./src/decomment.c", 145, __extension__ __PRETTY_FUNCTION__))
# 145 "./src/decomment.c"
                ;
        break;
    }
...
# 156 "./src/decomment.c"
    ...
    switch (state){
      ...
      case END_BLOCK_COMMENT:
        fprintf(
# 170 "./src/decomment.c" 3 4
               stderr
# 170 "./src/decomment.c"
                     , "Error: line %d: unterminated comment\n", line_com);
        return(
# 171 "./src/decomment.c" 3 4
              1
# 171 "./src/decomment.c"
                          );
        break;
...
# 179 "./src/decomment.c"
       "0"
# 179 "./src/decomment.c" 3 4
       , "./src/decomment.c", 179, __extension__ __PRETTY_FUNCTION__))
# 179 "./src/decomment.c"
                ;
        break;
    }
