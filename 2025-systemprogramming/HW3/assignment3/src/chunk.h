...
/* 
   ...
   a pointer to the ptr chunk in the free list. the size of a chunk
...
/* chunk_get_prev_adjacent_footer:
 * Returns the prev adjacent chunk footer to 'c' in memory space.
 * Returns NULL if 'c' is the first chunk in memory space. */
Chunk_T
chunk_get_prev_adjacent_footer(Chunk_T c, void* start, void* end);

/* chunk_get_footer:
 * Returns the chunk footer to 'c' in memory space. */
Chunk_T
chunk_get_footer(Chunk_T c, void* start, void* end);

/* chunk_get_header:
 * Returns the chunk header to 'c' in memory space.*/
Chunk_T
