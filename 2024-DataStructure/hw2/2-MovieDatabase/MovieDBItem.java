...
public class MovieDBItem implements Comparable<MovieDBItem> {
    ...
    public int compareTo(MovieDBItem other) {
        ...
        if (this.getGenre().compareTo(other.getGenre()) > 0) return 1;
        else if(this.getGenre().compareTo(other.getGenre()) < 0) return -1;
        else{
            if (this.getTitle().compareTo(other.getTitle()) > 0) return 1;
            else if(this.getTitle().compareTo(other.getTitle()) < 0) return -1;
            else return 0;
        }
